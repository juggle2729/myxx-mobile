            ...
            <div class="contact">
                ...
                <div class="content">
                    <div class="gray font-26" v-show="masterBaseData.phone || masterBaseData.weixin">
                        ...
                        <div class="flex" v-show="masterBaseData.weixin"><img :src="'wechat.svg' | qn" class="flex"/><span class="flex">{{masterBaseData.weixin}}</span></div>
                    </div>
                    <div class="gray font-26" v-show="masterBaseData.qq || masterBaseData.email">
                        <div class="right-120 flex" v-show="masterBaseData.qq"><img src="'qq.svg' | qn" class="flex"/><span class="flex">{{masterBaseData.qq}}</span></div>
                        <div class="flex email" v-show="masterBaseData.email" :class="{'wrap-row': masterBaseData.qq}"><img src="'email.svg' | qn" class="flex"/><span class="flex">{{masterBaseData.email}}</span></div>
                    </div>
