...
<div class="shop-request">
    ...
    <div class="request" :class="{'hide': !requestShow}">
        ...
        <div class="input">
            <input class="font-30 border-default" type="text" placeholder="手机号" v-model="contact"><div></div>
            <input class="font-30 border-default"  type="text" placeholder="姓名" v-model="name"><div></div>
