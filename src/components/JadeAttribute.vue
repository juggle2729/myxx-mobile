...
<template>
<div class="jade-attribute bg-default">
	<div class="params bg-white">
        <ul>
            ...
            <li v-if="jade.gift_to" class="flex font-26">
                <p class="label gray">赠送对象</p>
                <p class="flex-1">{{jade.gift_to | tree}}</p>
            </li>
            <li v-if="jade.gift_when" class="flex font-26">
