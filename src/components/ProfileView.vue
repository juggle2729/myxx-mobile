    ...
    <div class="profile">
      <div class="account bg-white border-bottom">
        ...
        <div class="user">
            ...
            <p class="font-26 txt-gray" style="margin-top:16px;" >{{roleName}}</p>
        </div>
        <span class="icon-enter font-26 txt-gray"></span>
      </div>
      <div class="community border-bottom">
        <div v-link="{name: 'topic'}">
            <div>
                <p class="font-30 txt-primary" align="center">16</p>
                <p class="font-26 txt-gray" align="center" style="margin-top:14px;">话题</p>
            </div>
        </div>
        <div v-link="{name: 'following'}">
            <div>
                <p class="font-30 txt-primary" align="center">314</p>
                <p class="font-26 txt-gray" align="center" style="margin-top:14px;">关注</p>
            </div>
        </div>
        <div v-link="{name: 'follower'}">
            <div>
                <p class="font-30 txt-primary"align="center" >234</p>
                <p class="font-26 txt-gray" align="center" style="margin-top:14px;">粉丝</p>
            </div>
        </div>
      </div>
      ...
      <div class="row bg-white txt-primary font-30 border-bottom" v-link="{path: '/self/evaluation'}">
          ...
          <span class="icon-enter txt-gray font-26"></span>
      </div>
      ...
      <div class="row bg-white txt-primary font-30 border-bottom">
          ...
          <span>设置</span>
          <span class="icon-enter txt-gray"></span>
      </div>
  </div>
</template>
<script>
