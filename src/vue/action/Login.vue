...
.login.center
    ...
    div
        ...
        input(name="code", v-model="code", type="text", placeholder="验证码")
        input.white.bg-red(@click="requestCode", type="button", v-model="label")
    .msg.fz-34.bg.red.pd(v-show="msg") {{msg}}
</template>
<script>
export default {
    name: 'Login',
