...
<div class="evaluation">
    ...
    <template v-for="item in current.items">
        <div class="item">
            <div class="header">
                <div class="user">
                    <div class="avatar" v-link="{name: item.user.role=='3' ? '' : '', params: {id: item.user.id}}" v-bg.sm="item.user.photo"></div>
                    <div class="name">
            ...
            <div class="video" v-bg.bg="item.picture" v-link="{name: 'evaluation-detail', params: {id: item.post_id}}"></div>
            ...
            return function() {
                ...
                return this.$http
                    .get('sns/jianbao', params, ({data}) => {
                        this.current.items.splice(this.current.items.length - 1, 0, ...data.jianbaos);
