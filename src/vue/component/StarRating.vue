    ...
    <div :class="['vue-star-rating', {'vue-star-rating-rtl':rtl}, {'vue-star-rating-inline': inline}]">
        <div @mouseleave="resetRating" class="vue-star-rating">
            <span v-for="n in maxRating" :key="n" :class="[{'vue-star-rating-pointer': !readOnly }, 'vue-star-rating-star']">
              <star :fill="fillLevel[n]" :size="starSize" :star-id="n+1" :step="step" :active-color="activeColor" :inactive-color="inactiveColor" :border-color="borderColor" :border-width="borderWidth" :padding="padding" @star-selected="setRating($event, true)" @star-mouse-move="setRating" :rtl="rtl"></star>
            </span>
    ...
    methods: {
        ...
        createStars(round = true) {
            ...
            for (var i = 0; i < this.maxRating; i++) {
                ...
                Vue.set(this.fillLevel, i, Math.round(level))
            }
        },
        round() {
