...
<template>
<div class="profile-view bg-default" v-if="!$loadingRouteData">
    ...
    <div class="account bg-white border-bottom flex" v-link="self | profile">
        ...
        <div class="user flex-1">
            ...
            <p class="font-26 gray">{{profile.role | role}}</p>
        </div>
...
export default {
    ...
    route: {
        data() {
            ...
            if(id) {
                return this.$get(`users/${id}/profile|v2`)
                    .then(profile => {
