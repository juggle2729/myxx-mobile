export default {
    ...
    img: {
        ...
        avatar_placeholder: 'http://7xp1h7.com2.z0.glb.qiniucdn.com/avatar-default.jpg',
        video_placeholder: 'http://7xp1h7.com2.z0.glb.qiniucdn.com/video-placeholder.png',
        play_placeholder: 'http://7xp1h7.com2.z0.glb.qiniucdn.com/play_placeholder.png',
        lg(id) {
            if(id) {
        ...
        play(id) {
            if(id) {
                return 'http://7xo88d.media1.z0.glb.clouddn.com/' + id + '?vframe/jpg/offset/1/w/300/h/250/rotate/auto';
            }
        }
    },
    video: {
