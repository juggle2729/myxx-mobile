...
<template>
    <div class="product-recommend bg-white" v-if="items.length">
        <div class="hr"></div>
        <div class="title fz-26 gray">商品推荐</div>
        <div class="list">
            <div class="item fz-26" v-for="data in items" v-link="{name: 'jade', params: {id: data.entry.id, tab: 'detail'}}">
